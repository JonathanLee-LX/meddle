/**
 * meddle session prune - Remove registry entries whose process is gone.
 *
 * Keeps the data directories intact (use `meddle session delete <id> --clean`
...
for (const s of removed) {
    ...
    console.log(chalk.gray(`    data dir kept: ${s.meddleHome}`))
}
console.log(chalk.gray('\nTo also delete data directories, run: meddle session delete <id> --clean'))
