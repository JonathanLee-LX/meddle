...
const pluginsDir = path.resolve(meddleDir, 'plugins-data');
 ...
 * Config is stored in ~/.meddle/plugins-data/{plugin-id}.json
 */
 ...
 * Store is stored in ~/.meddle/plugins-data/{plugin-id}.store.json
 */
